  ...
  (let* ((tool (string-downcase (or tool "")))
    ...
    (labels ((mac (pkg)
      ...
      (cond
        ...
        ((string= tool "xz")
         (remove nil (list (and is-mac (mac "xz"))
                           (and (not is-win) (deb "xz-utils"))
                           (and (not is-win) (fed "xz"))
                           (and is-win (win "xz")))))
        ((string= tool "bzip2")
         (remove nil (list (and is-mac (mac "bzip2"))
                           (and (not is-win) (deb "bzip2"))
                           (and (not is-win) (fed "bzip2"))
                           (and is-win (win "bzip2")))))
        ((string= tool "sbcl")
