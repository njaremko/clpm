...
(defparameter +agent-skill-markdown-lines+
  '("---"
    ...
    ""
    "For source edits, prefer `clpm repl call load-system --name SYSTEM` to rehydrate ASDF-stale files in the live image, `--force true` for a complete reload, and `watch-system` or `watch` when you want save-triggered reload events."
    ""
