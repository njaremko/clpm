...
(defparameter +agent-skill-markdown-lines+
  '("---"
    ...
    "## Repl Bridge"
    ""
    "`clpm repl-bridge` gives agents a persistent project-scoped Lisp image. Prefer it for iterative Common Lisp development because definitions, packages, workers, and debugger sessions can persist across calls."
    ""
    "Useful commands:"
    ""
    "```sh"
    ...
    "```"
    ""
    "Use `--keep` when you want a server-owned debugger session that can be driven by follow-up commands. Run `clpm repl-bridge diff` before claiming source and image state agree."
    ""
