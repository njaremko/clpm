...
(defparameter +agent-skill-markdown-lines+
  '("---"
    ...
    ""
    "For source edits, prefer `clpm repl call load-system --name SYSTEM` to rehydrate ASDF-stale files in the live image and `--force true` for a complete reload. Use `watch-system` for save-triggered ASDF reloads; use `watch` only when direct-loading individual files is what you want."
    ""
