...
(let ((readme (read-file-string (merge-pathnames "README.md" *repo-root*))))
  ...
  (assert-contains readme "clpm project workspace deps add [--dir <path>] [--path <dir>\\|--workspace <member>\\|--git <url> --ref <ref>] [<system>]")
  (assert-contains readme "clpm deps add [--dev\\|--test] [--any\\|--caret] [--path <dir>\\|--workspace <member>\\|--git <url> --ref <ref>] [<system>[@^<semver>\\|@=<exact>\\|@workspace]...]")
