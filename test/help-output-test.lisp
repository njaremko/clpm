...
(multiple-value-bind (code stdout stderr)
  ...
  (assert-contains stdout "search")
  (assert-contains stdout "info")
  (assert-contains stdout "tree")
  (assert-contains stdout "why")
  (assert-contains stdout "scripts")
  (assert-contains stdout "audit")
  (assert-contains stdout "sbom")
...
(format t "Testing `clpm help search` output...~%")
(multiple-value-bind (code stdout stderr)
    (run-cli-captured '("help" "search"))
  (declare (ignore stderr))
  (assert-eql 0 code)
